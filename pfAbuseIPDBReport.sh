#script for reporting to abuseipdb
#!/bin/bash

REPORTED_IP_LIST_FILE=/home/pi/abuseipdb-reported-ip-list
FAIL2BAN_SQLITE_DB=need to make this a webcall to mailcow #/var/lib/fail2ban/fail2ban.sqlite3
...
ipMatch=`grep -E "IP=$IP L=[0-9\-]+" $REPORTED_IP_LIST_FILE`
